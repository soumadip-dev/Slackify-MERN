    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a0b2e] via-[#16213e] via-[#0f3460] via-[#533483] to-[#7209b7] bg-[radial-gradient(ellipse_at_top_left,_rgba(116,58,213,0.15)_0%,_transparent_50%),_radial-gradient(ellipse_at_bottom_right,_rgba(74,21,75,0.15)_0%,_transparent_50%)] p-8 relative overflow-hidden">
      ...
      <Chat client={chatClient}>
        <div className="max-w-[1400px] mx-auto h-[calc(100vh-4rem)] flex bg-white/5 rounded-3xl backdrop-blur-[25px] border border-[rgba(116,58,213,0.2)] shadow-[0_30px_60px_rgba(0,0,0,0.3),_0_0_100px_rgba(116,58,213,0.1),_inset_0_1px_0_rgba(255,255,255,0.1)] overflow-hidden relative z-10">
          {/* LEFT SIDEBAR */}
          <div className="h-full backdrop-blur-[25px] border-none overflow-hidden relative shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_inset_-1px_0_0_rgba(255,255,255,0.05)] bg-inherit">
            <div className="h-full relative z-1 bg-gradient-to-b from-[#4a154b] via-[#350d36] via-[#2d0b2e] via-[#350d36] to-[#4a154b] bg-[linear-gradient(45deg,_rgba(116,58,213,0.3)_0%,_rgba(74,21,75,0.5)_30%,_rgba(114,9,183,0.4)_60%,_rgba(83,52,131,0.3)_100%)] flex flex-col">
              {/* HEADER */}
              <div className="px-6 py-8 border-b border-white/10 flex items-center justify-between relative z-2 flex-shrink-0">
                <div className="flex items-center gap-4 relative">
                  <img
                    src="../../public/logo.png"
                    alt="Logo"
                    className="w-12 h-12 rounded-xl shadow-[0_8px_25px_rgba(74,21,75,0.4),_0_4px_15px_rgba(114,9,183,0.3),_inset_0_1px_0_rgba(255,255,255,0.2)] transition-all duration-300 hover:scale-105 hover:shadow-[0_12px_35px_rgba(74,21,75,0.5),_0_6px_20px_rgba(114,9,183,0.4),_inset_0_1px_0_rgba(255,255,255,0.25)]"
                  />
                  <span className="text-2xl font-800 font-mono tracking-wide bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent text-shadow-[0_2px_10px_rgba(255,255,255,0.1)] relative">
                    Slackify
                  </span>
                </div>
                <div className="relative z-10 p-1 pb-0 rounded-xl bg-white/5 backdrop-blur-[10px] border border-white/10 transition-all duration-300 hover:bg-white/8 hover:border-white/15 hover:shadow-[0_4px_15px_rgba(74,21,75,0.2)]">
                  <UserButton />
                </div>
              </div>
              {/* CHANNELS LIST */}
          ...
          {/* RIGHT CONTAINER */}
          <div className="flex-1 bg-white/98 rounded-r-[2rem] overflow-hidden">
